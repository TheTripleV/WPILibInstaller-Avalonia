...
module Artifacts = 
    let artifacts =
        [
            ...
            { Package = WPILibCore
              Platform = MacArm64
              Url = $"https://wpilib.jfrog.io/artifactory/wpillib-mvn-testing-local/WPILib_MacArm-{wpilib_version}-artifacts.tar.gz"
              Hash = Some <| SHA256 "90cdecc3eb26a71ef430f8e769d40c2950a2dfe47f7c27cb49ef90059434908a" }
